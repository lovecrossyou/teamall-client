...
const api = {
	...
	createAddress: (params) => {
		...
		return request.post('/productService/createDeliveryAddress', params)
	},
	//删除收货地址
	deleteAddress: (params) => {
		...
		return request.post('/productService/deleteDeliveryAddress', params)
	},
	//更新收货地址
	updateAddress: (params) => {
		...
		apiParams.reqUpdateAddressModel = params;
		apiParams.accessInfo = {
			accessToken: '848424e6f83c42bf8f7a259fb8ba764b',
			accessSecret: '1bfa6b9592fa49b398a25eb6ba476639'
		};
		return request.post('/productService/updateDeliveryAddress', apiParams)
	},

	// ReqUpdateAddressMsg {
	// accessInfo (AccessInfo, optional),
	// reqUpdateAddressModel (ReqUpdateAddressModel, optional)
	// }

	// ReqUpdateAddressModel {
	// areaAddress (string, optional),
